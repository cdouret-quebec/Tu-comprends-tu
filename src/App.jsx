...
Si le sujet du guide touche au tutoiement/vouvoiement avec la clientèle : le tutoiement est effectivement fréquent et bien accepté en commerce de détail québécois, mais NE le présente PAS comme automatique ou universel. Nuance obligatoire : ça varie selon l'établissement (certains commerces haut de gamme restent au vouvoiement), selon l'âge du client (avec une clientèle plus âgée, plusieurs employés restent au vouvoiement par respect, au moins au premier contact), et ça reste courant d'ajuster selon le ton que le client lui-même emploie. Ne dis jamais qu'un immigrant "se sentirait mal à l'aise" en vouvoyant un client plus âgé — c'est en fait souvent perçu positivement. Utilise des formulations nuancées ("il est fréquent que...", "plusieurs employés...") plutôt que des généralisations absolues.
IMPORTANT sur les exemples ("exemples") : la nuance doit être DÉMONTRÉE concrètement, pas juste affirmée dans le texte explicatif. Parmi les exemples fournis, au moins UN doit montrer une situation où l'employé choisit le VOUVOIEMENT avec un client (ex: client visiblement âgé, contexte plus formel, ou établissement haut de gamme) — ne fais pas des exemples qui montrent tous le tutoiement comme si c'était systématique.` : "";

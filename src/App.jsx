...
Pour les définitions : "carte-soleil" = nom familier donné à la carte d'assurance maladie du Québec (pas besoin de la décrire visuellement). "RAMQ" = Régie de l'assurance maladie du Québec, organisme responsable notamment de l'administration du régime d'assurance maladie et du régime public d'assurance médicaments (pas seulement "gère les soins"). "médecin de famille" = médecin qui assure habituellement le suivi médical général d'un patient (évite la comparaison avec le "médecin traitant" français, qui n'est pas une notion institutionnelle équivalente). "de garde" = qui assure un service ou une disponibilité en dehors ou en complément des heures habituelles (pas nécessairement un "quart de travail").
Utilise "officiel" comme categorie pour RAMQ, DSQ, carte d'assurance maladie/carte-soleil, régime public d'assurance médicaments — et "secteur" pour le vocabulaire clinique/professionnel courant (posologie, ordonnance, dossier médical).` : "";
      return `Tu es expert du québécois parlé dans le secteur "${s.label}" (${s.contexte}). Génère un dialogue réaliste (5-7 répliques) avec des traits phonétiques et des contractions typiques du québécois ET vocabulaire du secteur.${registreNote}${financeExemple}${santeNote} Note: "croche" (pas droit) et NON "croché" — ça veut dire "pas droit, de travers, mal aligné", PAS "non conforme" au sens réglementaire (une pièce peut être croche sans être officiellement non conforme; garde "non-conformité" comme terme professionnel séparé si besoin). Exemples: ${s.exemples.join(", ")}.

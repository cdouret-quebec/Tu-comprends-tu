...
Le jargon Agile/TI anglophone (backlog refinement, staging, PR, dashboard, API, CI/CD, parking lot, etc.) est très utile pour reproduire le parler réel d'une équipe TI, mais ce n'est PAS une particularité québécoise — ne le mets pas dans les explications comme "quebecois", et ne le classe "secteur" que s'il s'agit vraiment de jargon propre au métier plutôt que d'un simple emprunt tel quel à l'anglais (auquel cas "anglicisme" convient mieux).` : "";

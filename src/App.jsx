...
Pour "se revirer de bord", garde la couleur de l'expression dans la définition plutôt que de l'aseptiser : "changer rapidement d'approche, s'adapter à une nouvelle situation, se réorganiser" — et indique "registre" : "familier".
Pour "pitcher une idée" : classe "pitcher" comme "anglicisme". Terme standard : "présenter, proposer ou soumettre une idée".
...
Pour "avant-midi" (matinée, période de la journée avant midi) et "asteure" (maintenant, à présent — s'entend "astheur"/"asteur") : classe-les "quebecois".
